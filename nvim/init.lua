...
vim.keymap.set("n", "<leader>dh", [[:read !ghead -n -1 < <(ghc -e "")<Left><Left>]], { desc = "Insert Haskell expr" })

vim.keymap.set("n", "<leader>ca", ':w! | AsyncRun compiler "%"<cr>', { desc = "Async compile" })

vim.keymap.set("n", "<leader>cc", ':w! | !compiler "%"<cr>', { desc = "Compile" })
